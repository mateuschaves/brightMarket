...
const mapStateToProps = ({ productNotRegisteredModal }) => ({
    productNotRegisteredModalVisible: productNotRegisteredModal.productNotRegisteredModalVisible,
});

const mapDispatchToProps = dispatch =>
    bindActionCreators({ hideProductNotRegisteredModal, showProductNotRegisteredModal }, dispatch);
